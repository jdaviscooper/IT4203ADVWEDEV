  ...
  if (length === 'short') {
    ...
    if (cast.length > 10) {
      castContainer.innerHTML += `<br><button onclick="appendCastInfo('long')">Show Full Cast</button><br>`;
		...
		castContainer.innerHTML += `<br><button id="searchButton" onclick="searchForMovies();document.getElementById('data-container').style.display='none';document.getElementById('popularMoviesContainer').style.display='flex';document.getElementById('btnClose').click()">Close</button>`;
    ...
    castContainer.innerHTML += `<br><button onclick="appendCastInfo('short')">Show Less</button><br>`;
		...
		castContainer.innerHTML += `<button id="searchButton" onclick="searchForMovies();document.getElementById('data-container').style.display='none';document.getElementById('popularMoviesContainer').style.display='flex';document.getElementById('btnClose').click()">Close</button>`;
